...
class Test(Resource):
    def get(self):
        mqtt.publish("/result_scan", payload= json.dumps({'scan_sensor': {'mac_gateway': '123124', 'unicast': 5, 'type_sensor': 1, 'type_device': 'sensor', 'value': 29,'unit': 'celsius', 'battery': 22}}))
